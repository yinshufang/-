...
class TuringChatMode(object):
    ...
    def get_turing_text(self, text):
        ...
        turing_url_data = dict(
            key='c7ded2036ddc46d0869c430b324af8d8',
            info=text,
            userid='MAC_ID',
        ...
        try:
            ...
            raise IndexError(
                "No internet connection available to transfer txt data")
            # 如果发生网络错误，断言提示没有可用的网络连接来传输文本信息
        except:
            raise KeyError(
                "Server wouldn't respond (invalid key or quota has been maxed out)")
